...
<body>
  ...
  <div class="head-container">
    ...
    <div class="header-text">
      <div class="text-one">
        <p class="large-text">Accomm-</p>
        <p class="large-text">dations</p>
      </div>
       <div class="text-two">
        <img src="images/haven-hero3.png" alt="">
       </div>
    </div>
    ...
    <div class="input-container">
      ...
      <form class="form">
        ...
        <div class="form__div">
          <input type="text" name="" id="checkinput" class="form__input" placeholder="Sep 19, 2023" value="">
        ...
        <div class="form__div">
          <input type="text" name="" id="checkinput2" class="form__input" placeholder="Sep 19, 2023">
